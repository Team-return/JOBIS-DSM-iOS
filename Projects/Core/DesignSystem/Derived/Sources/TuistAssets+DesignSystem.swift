...
public enum DesignSystemAsset {
  ...
  public enum Icons {
    ...
    public static let bookmarkList = DesignSystemImages(name: "BookmarkList")
    public static let fetchRecruitment = DesignSystemImages(name: "FetchRecruitment")
    public static let findCompany = DesignSystemImages(name: "FindCompany")
    ...
    public static let recruitment = DesignSystemImages(name: "recruitment")
